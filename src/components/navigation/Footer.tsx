    ...
    >
      ...
      <div className="relative z-10 ei-container max-w-[1220px]">
        {isCompact ? (
          ...
          >
            <div>
              <span className="ei-type-footer-brand mb-2 block font-structural text-[11px] uppercase tracking-[0.18em]">
                Echo in Ink
              </span>
              <p className="ei-type-footer-copy max-w-[48ch] font-structural text-[12px] leading-[1.7]">
            ...
            <nav aria-label="Footer recovery navigation">
              <ul className="flex flex-wrap items-center gap-x-5 gap-y-1">
                <li>
                  <Link
                    to="/"
                    className="ei-type-footer-link inline-flex min-h-11 items-center font-structural text-[12px] transition-colors duration-400"
                  >
                    Home
                  </Link>
                </li>
            ...
            <div className="border-t border-[var(--ei-theme-border)] pt-4 md:col-span-2 md:flex md:items-center md:justify-between">
              <span className="ei-type-footer-meta block font-structural text-[10px] tracking-[0.1em]">
                © {new Date().getFullYear()} Echo in Ink
              </span>
              <a
                href="mailto:hello@echoin.ink"
                className="ei-type-footer-meta mt-2 inline-flex min-h-11 items-center font-structural text-[10px] tracking-[0.08em] md:mt-0"
              >
                hello@echoin.ink
              </a>
            </div>
